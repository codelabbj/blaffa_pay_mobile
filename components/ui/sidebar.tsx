...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="icon"
      className={cn("h-8 w-8 rounded-lg shadow-sm", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-3 w-auto bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700", className)}
      {...props}
    />
  )
})
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-lg p-3 text-left text-sm outline-none ring-blue-500 transition-all duration-200 hover:bg-blue-50 hover:text-blue-900 focus-visible:ring-2 active:bg-blue-100 active:text-blue-900 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-gradient-to-r data-[active=true]:from-blue-500 data-[active=true]:to-purple-600 data-[active=true]:text-white data-[active=true]:font-semibold data-[active=true]:shadow-lg data-[state=open]:hover:bg-blue-50 data-[state=open]:hover:text-blue-900 group-data-[collapsible=icon]:!size-9 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 dark:hover:bg-blue-900/20 dark:hover:text-blue-100 dark:active:bg-blue-900/30 dark:data-[active=true]:from-blue-600 dark:data-[active=true]:to-purple-700",
  {
    variants: {
      variant: {
        default: "hover:bg-blue-50 hover:text-blue-900 dark:hover:bg-blue-900/20 dark:hover:text-blue-100",
        outline:
          "bg-white/80 dark:bg-gray-800/80 shadow-[0_0_0_2px_hsl(var(--sidebar-border))] hover:bg-blue-50 hover:text-blue-900 hover:shadow-[0_0_0_2px_hsl(var(--sidebar-accent))] dark:hover:bg-blue-900/20 dark:hover:text-blue-100",
      },
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("rounded-lg h-9 flex gap-3 px-3 items-center", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
