...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-md px-3 py-2 text-sm font-semibold outline-none transition-all duration-200 focus:bg-blue-50 focus:text-blue-900 data-[state=open]:bg-blue-50 data-[state=open]:text-blue-900 dark:focus:bg-blue-900/20 dark:focus:text-blue-100 dark:data-[state=open]:bg-blue-900/20 dark:data-[state=open]:text-blue-100",
      className
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-md px-3 py-2 text-sm outline-none transition-all duration-200 focus:bg-blue-50 focus:text-blue-900 data-[state=open]:bg-blue-50 data-[state=open]:text-blue-900 dark:focus:bg-blue-900/20 dark:focus:text-blue-100 dark:data-[state=open]:bg-blue-900/20 dark:data-[state=open]:text-blue-100",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-md px-3 py-2 text-sm outline-none transition-all duration-200 focus:bg-blue-50 focus:text-blue-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-blue-900/20 dark:focus:text-blue-100",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-md py-2 pl-8 pr-3 text-sm outline-none transition-all duration-200 focus:bg-blue-50 focus:text-blue-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-blue-900/20 dark:focus:text-blue-100",
      className
    )}
    checked={checked}
    {...props}
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700", className)}
    {...props}
  />
))
